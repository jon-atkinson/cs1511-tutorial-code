// part1_galaxy.c
//
// This program was written by M15X
//
...
int main(void) {
  ...
  while (type != 'q') {
    ...
    if (type == 'p') {
      ...
      printf("Error: only PLANET and NEBULAE are supported for scanning\n");
      // this is an early return - the 1 represents some error occuring before
...
// Function to place stars in the galaxy
void place_stars(struct celestial_body galaxy[SIZE][SIZE]) { return; }
